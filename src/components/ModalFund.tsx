...
export interface ModalFundProps {
  show: boolean;
  onCloseModalFund: () => void;
}

const ModalFund: FC<ModalFundProps> = ({ show, onCloseModalFund }) => {
    ...
    return (
      <form action="#">
        ...
        <div className="mt-4 space-x-3">
          ...
          <ButtonSecondary type="button" onClick={onCloseModalFund}>
            Cancel
          </ButtonSecondary>
        </div>
      </form>
