...
const SectionHero: FC<SectionHeroProps> = ({
  className = "",
  heading = "Discover, fund, or purchase extraordinary GitNFTs ",
  subHeading = "Discover the most outstanding GitNTFs in all subjects of technology. Creative your NTFs and sell them",
}) => {
  return (
    <div
      ...
      <div className="flex flex-col lg:flex-row space-y-14 lg:space-y-0 lg:space-x-10 lg:items-center relative">
        <div className="w-screen max-w-full xl:max-w-xl space-y-5 lg:space-y-7">
          ...
          <div className="pt-7 flex  space-x-4">
            ...
            <ButtonSecondary href="/my-gitnft">
              <span>Create</span>
